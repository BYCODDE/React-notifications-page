  ...
  return (
    <section className="">
      ...
      <div className="gap-[7px] relative flex justify-start items-center rounded-[8px] bg-white pt-[18px] pb-[17px] pl-[20px] pr-[32px]">
        ...
        <span className="dark-grey-blue  font-bold  custom-font-style">5 end-game strategies to </span>
        <div>
        <span className="absolute top-12 left-[13%] dark-grey-blue  font-bold  custom-font-style">increase your win rate</span>
